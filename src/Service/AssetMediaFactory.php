...
use Drupal\helfi_gredi_image\MediaEntityHelper;
...
class AssetMediaFactory implements ContainerInjectionInterface {
   ...
   *
   * @return \Drupal\helfi_gredi_image\MediaEntityHelper
   *   A media entity wrapped with a helper class.
   */
  public function get(MediaInterface $media) {
    // Not ideal but the usage of media_gredidam.asset_file.helper gets flagged
